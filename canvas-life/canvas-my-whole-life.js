...
let LIFE_PHASE = [
    ...
    { name: '大专', dayIndex: '', date: '', dayRange: [], ageRange: [18, 21], color: 'blue', text: '大' },
    { name: '工作', dayIndex: '', date: '', dayRange: [], ageRange: [21, 24], color: 'DodgerBlue', text: '工' },
...
let LIFE_POINT_MINE = [
    { name: '爷爷去世', dayIndex: '', date: '2023-07-01', dayRange: [], ageRange: [], color: 'black', text: '' },
    { name: '75岁', dayIndex: '', date: '2079-03-13', dayRange: [], ageRange: [], color: 'gray', text: '' },
